...
# Author:                 Syed Awase Khirni sak@territorialprescience    #
# Script type:           Database creation script                        #
# Created on:            2013-1-09 10:13                                #
# ---------------------------------------------------------------------- #
...
CREATE TABLE `t1accounts` (
    ...
    `t1f1accountname` VARCHAR(250),
    `t1f1accountopendate` DATETIME,
    `t1f1accountclosedate` DATETIME,
    `t1f1accountdesc` VARCHAR(400),
    `t1f1accountbalance` DOUBLE,
...
CREATE TABLE `t4customers` (
    ...
    `t3f3customerphone` VARCHAR(40),
    `t3f3customerfrom` DATETIME,
    `t3f3customerlastlogin` DATETIME,
    `t3f3customerlastip` VARCHAR(100),
    `t3f3pwdchangedate` DATETIME,
    `t3f3transactionpassword` VARCHAR(40),
    `t3f3currentbalance` DOUBLE,
...
CREATE TABLE `t10merchants` (
    ...
    `t10f10merchantemail` VARCHAR(200),
    `t10f10merchantphone` VARCHAR(40),
    `t10f10merchantisactive` BOOL,
    `t10f10merchanturl` VARCHAR(250),
    `t10f10merchantaddress` VARCHAR(500),
    `t10f10merchantcity` VARCHAR(250),
    `t10f10merchantstate` VARCHAR(250),
    `t10f10merchantcountry` VARCHAR(250),
    `t10f10merchantzip` VARCHAR(40),
...
CREATE TABLE `t12transactions` (
    ...
    `t12f12transactionamount` DOUBLE,
...
CREATE TABLE `t13balancehistory` (
    `t13f13balanceatdate` DATETIME,
    `t13f13balanceamount` DOUBLE,
    `t1f1accountid` VARCHAR(40) NOT NULL,
